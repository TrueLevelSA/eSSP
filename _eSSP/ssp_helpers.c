...
SSP_RESPONSE_ENUM ssp6_set_route(
        SSP_COMMAND* sspC,
        const int value,
        const char* cc,
        const char route)
...
// Setup SSP encryption, sends SSP commands set generator (0x4A),
// set modulus (0x4B) and exchange keys (0x4C)
SSP_RESPONSE_ENUM ssp6_setup_encryption(
        SSP_COMMAND* sspC,
...
SSP_RESPONSE_ENUM ssp6_host_protocol(
        SSP_COMMAND* sspC,
...
// Send an SSP setup request (0x05), and parse the response
// into an SSP6_SETUP_REQUEST_DATA
SSP_RESPONSE_ENUM ssp6_setup_request(
        SSP_COMMAND* sspC,
        SSP6_SETUP_REQUEST_DATA* setup_request_data)
{
    ...
    // If the command did not succeeded, leave
    ...
    else
    {
        ...
        // The channel values can be ignored here
...
SSP_RESPONSE_ENUM ssp6_set_inhibits(
        SSP_COMMAND* sspC,
...
SSP_RESPONSE_ENUM ssp6_set_coinmech_inhibits(
        SSP_COMMAND* sspC,
        unsigned int value,
        const char* cc,
